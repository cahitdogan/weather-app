export default function WeatherInfo({ city }) {
    return (
        <section className="w-5/6 flex flex-col items-center mx-auto pb-6 border-b text-center">
            <h1 className="text-3xl font-semibold mb-1">{city.location}</h1>
            ...
            <div className="w-1/2 flex flex-col">
                <p className="flex justify-between border-b py-2">
                    <span>Feels Like</span>   <span>{city.feelsLike}</span>
                </p>
                <p className="flex justify-between border-b py-2">
                    <span>Wind</span>   <span>{city.wind}</span>
                </p>
